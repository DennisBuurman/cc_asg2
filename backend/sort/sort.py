"""
Sort worker program created by Jochem Ram (s2040328) and Dennis Buurman (s2027100) for
...
def update_job(filename):
    ...
    if doc_ref.get().to_dict()["num_chunks"] == doc_ref.get().to_dict()["done_sort_chunks"]:
...
def main():
    ...
    project_id = "cc-asg2"
    subscription_id = "cc-asg2-sort_sub"
